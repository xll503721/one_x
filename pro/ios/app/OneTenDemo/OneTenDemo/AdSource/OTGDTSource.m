...
@interface OTGDTSource ()<GDTUnifiedNativeAdDelegate, GDTUnifiedNativeAdViewDelegate, GDTRewardedVideoAdDelegate, GDTSplashAdDelegate, OTAdSourceProtocol>
...
- (void)loadSplashWithType:(OTAdSourceType)type userInfo:(NSDictionary<id, id> *)userInfo {
    ...
    splashAd.serverSideVerificationOptions = ssv;
