...
#import "OTPangleAdpater.h"

@interface OTPangleAdpater ()<PAGRewardedAdDelegate>

@end

@implementation OTPangleAdpater
...
- (void)loadRewardedVideoWithType:(OTAdSourceType)type userInfo:(NSDictionary<id, id> *)userInfo {
    ...
    [PAGRewardedAd loadAdWithSlotID:@"980088192" request:request completionHandler:^(PAGRewardedAd * _Nullable rewardedAd, NSError * _Nullable error) {
