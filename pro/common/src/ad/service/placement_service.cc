...
void PlacementService::GetPlacementModel(const std::string& placement_id, PlacementModelCallBack callBack) {
    ...
    https_client_.Get(path, [=](BASE_HTTPS::HTTPsClient* client, BASE_HTTPS::HTTPsClient::Status status, const std::string& body) {
        ...
        do {
            ...
            std::string placement_json_string = "{\"id\":\"123456789\",\"format\":0,\"c2s\":[],\"waterfall\":[{\"network_id\":0,\"restrict\":{\"day\":10,\"hour\":10,\"min\":1},\"list\":[{\"id\":\"111111\",\"placement_id\":\"2023121674786777\",\"ecpm_price\":100.0,\"params\":{}},{\"id\":\"2222\",\"placement_id\":\"123456789\",\"ecpm_price\":100.0,\"params\":{}},{\"id\":\"3333\",\"placement_id\":\"123456\",\"ecpm_price\":100.0,\"params\":{}},{\"id\":\"44444\",\"placement_id\":\"123456789\",\"ecpm_price\":100.0,\"params\":{}}]}]}";
